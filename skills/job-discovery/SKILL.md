...
- Output written to the report (subagent output and integration results) must NOT contain file paths, plan references, or any external file references — the report must be a self-contained deliverable
